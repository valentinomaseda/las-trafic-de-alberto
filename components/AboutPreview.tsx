    ...
    <section id="about" className="bg-white py-20 sm:py-24">
      <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8">
        <SectionReveal className="flex flex-col justify-center">
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-sky-600">Sobre el servicio</p>
          ...
          <div className="mt-8 space-y-4">
            {[
              ...
              <article key={title} className="flex gap-4 rounded-3xl border border-slate-200 bg-slate-50 p-5 shadow-sm transition hover:shadow-md">
        ...
        <SectionReveal delay={0.12} className="relative">
          <motion.article
            ...
            className="relative min-h-[26rem] overflow-hidden rounded-[2rem] bg-slate-900 p-6 text-white shadow-2xl shadow-slate-900/15"
          >
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_rgba(56,189,248,0.25),_transparent_32%),linear-gradient(145deg,rgba(15,23,42,0.9),rgba(30,41,59,0.96))]" />
            <div className="relative flex h-full flex-col justify-between">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.24em] text-sky-300">Experiencia del viaje</p>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur">
                  <p className="text-sm text-slate-300">Asistencia</p>
                  <p className="mt-1 text-2xl font-semibold text-white">Coordinada</p>
                </div>
                <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur">
                  <p className="text-sm text-slate-300">Enfoque</p>
